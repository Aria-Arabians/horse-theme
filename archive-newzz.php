    ...
    <div class="banner-section">
        <div class="row">
            <div class="medium-12 columns">
                <h1 class="PlayfairDisplay">The Aria Team</h1>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <?php if (have_posts()) : ?>
                ...
                while (have_posts()) : the_post(); ?>
                    <div class="client-services-block">
                        <div class="row eq-parent <?php if ($flipper % 2 == 0) {
                            echo "flipped";
                        } ?>">
                            ...
                            <div class="large-5 medium-6 columns eq-child">
                                ...
                                <h3><?php print_r(get_the_tags()[0]->name); ?></h3>
                                <?php get_the_tags() ?>
                                <div class="separator text-left"><img
                                            src="http://aria.testsite/wp-content/themes/horse/images/separator2.png">
                                </div>
                                <?php the_excerpt(); ?>
                            </div>
                        </div>
